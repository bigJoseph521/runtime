...
from alphovex_sdk.indicators.examples.ASI import ASI
...
output_path = (
    ...
    "test/indicators/sample/ASI/test_results.jsonl"
)
...
with file_path.open(
    ...
    for record in read_jsonl(jsonl_path):
        ...
        # Call calculate() exactly once because ASI maintains
        # committed state for completed bars.
        result = asi.calculate(
            list(bars),
            is_new_bar,
        )
